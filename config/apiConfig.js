...
let config = {
    server: { 
        ...
        dev_uri: "ws://119.28.204.125:8080/ws" //"ws://119.28.204.125:8080/ws"
    },
    platforms: [
        {   
            site: "okex",
            ...
            symbols: [
                ...
                { symbol: "ltc#usd_2w", alias: "ltc#usd_next-week", duration: "P12DT16H" },
                { symbol: "ltc#usd_1q", alias: "ltc#usd_quarter", duration: "LPT16H" },

                { symbol: "eth#usd_1w", alias: "eth#usd_this-week", duration: "P5DT16H" },
                { symbol: "eth#usd_2w", alias: "eth#usd_next-week", duration: "P12DT16H" },
                { symbol: "eth#usd_1q", alias: "eth#usd_quarter", duration: "LPT16H" },

                { symbol: "etc#usd_1w", alias: "etc#usd_this-week", duration: "P5DT16H" },
                { symbol: "etc#usd_2w", alias: "etc#usd_next-week", duration: "P12DT16H" },
                { symbol: "etc#usd_1q", alias: "etc#usd_quarter", duration: "LPT16H" },

                { symbol: "bch#usd_1w", alias: "bch#usd_this-week", duration: "P5DT16H" },
                { symbol: "bch#usd_2w", alias: "bch#usd_next-week", duration: "P12DT16H" },
                { symbol: "bch#usd_1q", alias: "bch#usd_quarter", duration: "LPT16H" },

                { symbol: "eos#usd_1w", alias: "eos#usd_this-week", duration: "P5DT16H" },
                { symbol: "eos#usd_2w", alias: "eos#usd_next-week", duration: "P12DT16H" },
                { symbol: "eos#usd_1q", alias: "eos#usd_quarter", duration: "LPT16H" },

                { symbol: "xrp#usd_1w", alias: "xrp#usd_this-week", duration: "P5DT16H" },
                { symbol: "xrp#usd_2w", alias: "xrp#usd_next-week", duration: "P12DT16H" },
                { symbol: "xrp#usd_1q", alias: "xrp#usd_quarter", duration: "LPT16H" },
        ...
        },
        {
            ...
            symbols: ["btc#usd","ltc#usd","ltc#btc","eth#usd","eth#btc","etc#btc","etc#usd","bch#usd","bch#btc","bch#eth","eos#btc","eos#eth","eos#usd"],
