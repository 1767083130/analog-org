    ...
    dnnModal = { //global scope
        ...
        show: function (url, showReturn, height, width, refresh, closingUrl) {
            ...
            if ($modal.length == 0) {
                ...
                //2013-07-26 XDQ修改
                //                $(document).find('html').css('overflow', 'hidden'); //在阿里巴巴上弹出后再关闭，右边的下拉就没了，所有删除
                $(document).find("html>body").append($modal);
        ...
        closePopUp: function (refresh, url) {
            ...
            //2013-10-11 xdq 修改开始
            var cW = $("#iPopUp").get(0);
            if (cW && cW.contentWindow)
                cW = cW.contentWindow;
            refresh = refresh && !(cW && cW.dnnModal && cW.dnnModal.donotRefresh);
            //2013-10-11 xdq 修改结束
