                ...
                if(run){
                    try {
                        ...
                        if(Math.abs(stepAmount) > 0){
                            ...
                            // if(nextLogOperate.orgOperate.site == 'okex'){
                            //     let str = `runOperate! stepAmount: ${stepAmount} apiOrder: ${JSON.stringify(apiOrder)}`
                            //     debug(str)
                            //     fs.appendFile(path.join(__dirname,'logs', 'log.txt'), str + '\r\n\r\n', (err) =>  {
                            //         if (err) throw err;
                            //     }); 
                            // }
