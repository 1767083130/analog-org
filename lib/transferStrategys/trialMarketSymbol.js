...
let trialMarketSymbol = new class{
    ...
    /**
     * 从市场深度数据中获取交易品种
     * @param {Array} realPrices 可能包含多个网站的市场深度 e.g [ {site:'okex',[]} ]
     * @returns {Object} e.g  
     *   {isSuccess: true, 
     *    symbolPathPairs: [{ symbol: "bch#btc",reverse: false},{ symbol: "bch#eos", reverse: true}] } 
     */
    getSymbolPathPairs(realPrices){
        //根据site分组
        let groups = [];
    ...
    /**
     * 获取SymbolPathPairs
     * @param {*} siteGroupA 网站A的行情深度 e.g { site: "baidu",depths: [{symbol: "btc#usd",bids:[],asks:[]}]}
     * @param {*} siteGroupB 网站B的行情深度 e.g { site: "baidu",depths: [{symbol: "btc#usd",bids:[],asks:[]}]}
     * @param {*} depths 
     ...
     * 获取两个网站各自的兑换路径
     * 
     * @param {Object} siteGroupA e.g { site: "baidu",depths: [{symbol: "btc#usd",bids:[],asks:[]}]}
     * @param {Object} siteGroupB e.g { site: "qq",depths: [{symbol: "btc#usd",bids:[],asks:[]}]}
